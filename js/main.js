(function () {
    ...
    function renderBoard(board) {
        ...
        $(".turn").html("Agora é sua vez, jogador " + players[currentPlayer].name);
        ...
        if(valid) {
            ...
            if(!availableMoves.length) {
                ...
                if(!availableMovesNextPlayer.length) {
                    ...
                    setTimeout(function(){
                        alert("Jogador " + noTurnPlayerName + " SEM jogadas disponíveis. Passando a vez...");
                    }, 1000);
    ...
    function finishGame() {
        ...
        if(players[0].qtdPieces > players[1].qtdPieces) {
            messageWin = "Parabéns, o jogador " + players[0].name + " venceu!";
        } else if(players[1].qtdPieces > players[0].qtdPieces) {
            messageWin = "Parabéns, o jogador " + players[1].name + " venceu!";
        } else {
            messageWin = "DEU EMPATE!"
        }
